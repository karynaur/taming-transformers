...
CKPT_PATH = "/content/drive/MyDrive/deeplabv2_resnet101_msc-cocostuff164k-100000.pth"
...
class Examples(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv="/content/data/test.txt",
                         data_root="/content/data/images",
                         segmentation_root="/content/data/segmentations",
